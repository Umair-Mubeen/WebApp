# Generated by Django 5.0.7 on 2024-09-23 08:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_age', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('leave_type', models.CharField(choices=[('Casual Leave', 'Casual Leave'), ('Earned Leave', 'Earned Leave'), ('Ex-Pakistan Leave', 'Ex-Pakistan Leave'), ('Medical Leave', 'Medical Leave'), ('Study Leave', 'Study Leave'), ('Special Leave', 'Special Leave'), ('Maternity Leave', 'Maternity Leave')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('old_zone', models.CharField(blank=True, max_length=255)),
                ('new_zone', models.CharField(blank=True, max_length=255)),
                ('chief_order_number', models.IntegerField(default=0)),
                ('chief_transfer_date', models.DateField(null=True)),
                ('chief_reason_for_transfer', models.TextField(blank=True, null=True)),
                ('chief_order_approved_by', models.CharField(max_length=255)),
                ('chief_transfer_document', models.FileField(default=None, max_length=250, null=True, upload_to='transfer_documents/')),
                ('old_unit', models.CharField(blank=True, max_length=255, null=True)),
                ('new_unit', models.CharField(blank=True, max_length=255, null=True)),
                ('zone_range', models.CharField(blank=True, max_length=255, null=True)),
                ('zone_order_number', models.IntegerField(default=0)),
                ('zone_transfer_date', models.DateField(auto_now_add=True)),
                ('zone_reason_for_transfer', models.TextField(blank=True, null=True)),
                ('zone_order_approved_by', models.CharField(blank=True, max_length=255)),
                ('zone_transfer_document', models.FileField(default=None, max_length=250, null=True, upload_to='transfer_documents/')),
                ('zone_type', models.CharField(blank=True, max_length=255)),
